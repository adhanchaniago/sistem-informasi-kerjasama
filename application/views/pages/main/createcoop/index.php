  ...
  <div class="col-md-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-sm btn-warning" onclick="$('#input-upload').click()"><i class="fa fa-upload"></i> Upload Excel</button>
...
<div style="display:none">
  <?php echo form_open_multipart($cname.'/upload_excel',['id' => 'form-upload-excel']) ?>
  <input type="file" name="excel_file" id="input-upload">
